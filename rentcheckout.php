                            ...
                            <div class="col-lg-6">
                                <div class="your-order mb-30 ">
                                        ...
                                        <table>
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="product-total">Total (USD)</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                              <?php foreach ($selectuserwishlist as $row) { ?>
                                                <tr class="cart_item">
                                                    <td class="product-name">
                                                        <?= $row['productname']; ?> <strong class="product-quantity"> × 1</strong>
                                                    </td>
                                    ...
                                    <div class="payment-method">
                                        ...
                                        <button type="submit" class="btn-tp" name="order_rent_btn">Place order</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
